...
@Component({
  selector: 'app-criterio-validacao',
  standalone: true,
  imports: [
    NgClass,
    NgIf,
  ...
  templateUrl: './criterio-validacao.component.html',
  styleUrl: './criterio-validacao.component.scss'
})
export class CriterioValidacaoComponent {
  form!: FormGroup;
