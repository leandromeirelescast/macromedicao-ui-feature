...
@Component({
  selector: 'app-recomposicao-dados',
  standalone: true,
  imports: [
    NgClass,
    NgIf,
  ...
  templateUrl: './recomposicao-dados.component.html',
  styleUrl: './recomposicao-dados.component.scss'
})
export class RecomposicaoDadosComponent {
  form!: FormGroup;
